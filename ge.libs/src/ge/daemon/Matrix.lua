...
-- << class - MatrixObject >>
local MatrixObject = class.define("ge.daemon.MatrixObject",{})
...
-- class: Matrix
local Matrix = class.define("ge.daemon.Matrix", {ge.daemon.MatrixObject})
...
-- <<class - Command>>
local MatrixCommand = class.define("ge.daemon.MatrixCommand", {bma.lang.StdObject})
