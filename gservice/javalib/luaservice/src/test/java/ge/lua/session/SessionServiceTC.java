...
public class SessionServiceTC {

	final org.slf4j.Logger log = org.slf4j.LoggerFactory
			.getLogger(SessionServiceTC.class);
	...
	@Test
	public void session_testcase() throws Exception {
		...
		try {
			...
			if (obj != null) {
				String params = "[\"bma.session.session_testcase\"]";
